...
var __1 = require("..");
var GenericParser_1 = require("./GenericParser");
var GoParser_1 = require("./GoParser");
var JSParser_1 = require("./JSParser");
var JavaParser_1 = require("./JavaParser");
var ObjcParser_1 = require("./ObjcParser");
    ...
    try {
        ...
        line: for (var i = 0; i < log.length; i++) {
            if (i == log.length - 1 || log[i] == "\n") {
                ...
                for (var _f = 0, parsers_1 = parsers; _f < parsers_1.length; _f++) {
                    var parser = parsers_1[_f];
        ...
        for (var _g = 0, parsers_2 = parsers; _g < parsers_2.length; _g++) {
            var parser = parsers_2[_g];
        ...
        for (var _h = 0, tests_1 = tests; _h < tests_1.length; _h++) {
            var test_1 = tests_1[_h];
        ...
        throw new Error("Unable to parse log file: ".concat(e));
    }
}
